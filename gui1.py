...
class Login(Frame):
    ...
    def Remove_small_objects(self):
        im1 = cv2.imread(os.path.join(os.getcwd(), 'p5Anti A.png'))
        cv2.imshow('Anti-A', im1)
        im2 = cv2.imread(os.path.join(os.getcwd(), 'p5Anti B.png'))
        cv2.imshow('Anti-B', im2)
        im3 = cv2.imread(os.path.join(os.getcwd(), 'p5Anti D.png'))
        cv2.imshow('Anti-D', im3)
        im4 = cv2.imread(os.path.join(os.getcwd(), 'p5Control.png'))
        cv2.imshow('Control', im4)
        cv2.waitKey(0)
        cv2.destroyAllWindows()
